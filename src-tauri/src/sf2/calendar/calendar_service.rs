...
pub(crate) use crate::sf2::roster::{
...
pub(crate) use crate::sf2::roster_sync::{
    sync_latest_workbook_roster_for_class, sync_template_roster_from_class,
    sync_workbook_roster_for_class,
};

pub(crate) use crate::sf2::template_ops::create_workbook_from_template;
pub(crate) use crate::sf2::template_update::update_workbook_settings;
