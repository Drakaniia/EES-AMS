...
pub(crate) use super::roster::{
    ...
    reject_duplicate_roster_names,
    sync_workbook_learner_mappings,
    template_owns_roster,
...
pub(crate) use super::roster_sync::{
    sync_latest_workbook_roster_for_class,
    sync_template_roster_from_class,
    sync_workbook_roster_for_class,
};

pub(crate) use super::template_ops::{
