...
mod tests {
    ...
    #[test]
    fn attendance_marks_clear_present_cells_and_write_absences_for_one_closed_day() {
        let students = vec![
            Sf2StudentMapping {
                student_id: "student-present".to_string(),
                sheet_name: "JUNE 2026".to_string(),
                row_index: 12,
            },
            Sf2StudentMapping {
                student_id: "student-absent".to_string(),
                sheet_name: "JUNE 2026".to_string(),
                row_index: 13,
            },
        ];
        let present_events = vec![Sf2AttendanceEvent {
            student_id: "student-present".to_string(),
        ...
        assert_eq!(
            ...
            vec![
                Sf2CellMark {
                    sheet_name: "JUNE 2026".to_string(),
                    cell_address: "F12".to_string(),
                    value: String::new(),
                },
                Sf2CellMark {
                    sheet_name: "JUNE 2026".to_string(),
                    cell_address: "F13".to_string(),
