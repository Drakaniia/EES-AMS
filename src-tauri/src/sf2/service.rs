...
use crate::sf2::models::{
    ...
    Sf2ExportResult, Sf2ImportSummary, Sf2ImportValidation, Sf2PreviewAbsence, Sf2PreviewCell,
    Sf2PreviewCellStatus, Sf2PreviewDate, Sf2PreviewStudentRow, Sf2StudentMappingRecord,
    Sf2TemplateDraft, Sf2TemplateRecord, Sf2ValidationDuplicate, Sf2ValidationLearner,
    Sf2ValidationNameMismatch, Sf2ValidationStudent, Sf2WorkbookAnalysis, Sf2WorkbookLearner,
...
fn import_validation_from_analysis(
    pool: DbPool,
    workbook_path: &Path,
    analysis: &Sf2WorkbookAnalysis,
) -> Result<Sf2ImportValidation> {
...
fn ensure_import_validation_allows(
