use super::{
    ...
    rows::{
        attendance_audit_entry_from_row, attendance_event_from_row, attendance_session_key,
        audit_metadata, normalize_optional_text, serialize_audit_event, serialize_audit_payload,
    },
    DbPool,
};
use crate::domain::{
