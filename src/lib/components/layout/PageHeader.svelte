...
<header
	class="sticky top-0 z-40 shrink-0 border-b border-border bg-background px-4 py-4 shadow-sm md:px-8 md:py-5 lg:px-10"
>
	<div
	...
	>
		<div class="min-w-0">
			...
			{#if description}
				<p class="text-balance-safe mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
					{description}
				</p>
			{/if}
		</div>
