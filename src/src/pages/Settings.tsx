...
const Settings: FC = () => {
    ...
    const handleSubmitCode = async () => {
        ...
        try {
            // Submit auth code logic
            console.log('Submitting auth code:', authCode)
